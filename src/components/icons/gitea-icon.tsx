...
const GiteaIcon = ({ title, className, ...props }: IconProps) => (
  <svg
    className={className}
    width="16"
    height="16"
  ...
  >
    ...
    <path
      ...
      d="M622.7,149.8c-4.1-4.1-9.6-4-9.6-4s-117.2,6.6-177.9,8c-13.3,0.3-26.5,0.6-39.6,0.7c0,39.1,0,78.2,0,117.2
         ...
         c45.8,56.1,144.4,54.8,144.4,54.8s12.1,28.9,30.6,55.5
         c25,33.1,50.7,58.9,75.7,62c63,0,188.9-0.1,188.9-0.1s12,0.1,28.3-10.3
         c14-8.5,26.5-23.4,26.5-23.4s12.9-13.8,30.9-45.3
         c5.5-9.7,10.1-19.1,14.1-28c0,0,55.2-117.1,55.2-231.1
